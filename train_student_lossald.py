...
from helper.loops_lossald import train_distill as train, validate
...
def parse_option():
    ...
    # grad loss
    parser.add_argument('--ald', default=0.1, type=float, help='weight balance for ALD loss')
    parser.add_argument('--n', default=4, type=int, help='number of particles')
    ...
    opt.model_name = 'S:{}_T:{}_{}_{}_r:{}_a:{}_b:{}_{}_{}'.format(opt.model_s, opt.model_t, opt.dataset, opt.distill,
                                                                opt.gamma, opt.alpha, opt.beta, opt.trial, opt.ald)
